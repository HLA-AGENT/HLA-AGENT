...
/*---------SORT OUT TIME AS ABOVE---------*/
    ...
    ----------------------------------*/
    void enableTimeRegulation(theTime)
     unsigned long theTime;
    {}
...
exload rti ['-L/home/mhl/rti/RTI-1.3NGv4/Linux-rh62-i386-egcs-2.91.66-opt-mt/lib' '-L/usr/i386-glibc21-linux' '-lRTI-NG' '-lfedtime' '-lpthread' '-lrt' '-ldl' 'rti.so']

endexload

/*
external load rti;
      ['-L/home/mhl/rti/RTI-1.3NGv4/Linux-rh62-i386-egcs-2.91.66-opt-mt/lib' '-L/usr/i386-glibc21-linux' '-lRTI-NG' '-lfedtime' '-lpthread' '-lrt' '-ldl' 'rti.so']
endexternal;
*/
