#ifndef SimFederateAmbassador_h
#define SimFederateAmbassador_h
...
class SimFederateAmbassador : public RTI::FederateAmbassador
{
public:

SimFederateAmbassador();
virtual ~SimFederateAmbassador() throw(RTI::FederateInternalError);
