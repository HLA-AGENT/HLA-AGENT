...
;;;implemented. Otherwise change the line which calls the user simulation.
...
define run_experiment(num_runs,num_cycles /* &optional config */);
    ...
    sim_instrument_class(class_example(tile_agent_key), [sim_x sim_y]);
	...
	;;; ***Execute users simulation - in this case tileworld
	go(num_cycles,[^WIN_X ^WIN_Y 0 0 0 ^num_agents]);
...
;;; sim_process_tw.p ends here
vars sim_process_tw = true;
