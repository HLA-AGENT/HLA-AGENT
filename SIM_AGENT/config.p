...
vars 
    ...
    HLA_execName = 'TileWorld_run_1',

    ;;; The name of the file which describes the ?federation?
    HLA_fedFile = 'Tileworld.fed',

    ;;; A string naming this federate
    HLA_fedName = 'TileWorld',

    ;;; The number of federates in the federation
    HLA_fedSize = 1,
    ...
    ;;; This is a simple tile class with two attributes
    ;;; Used for testing 08/10/02
  HLA_FOM_alist = 
    [
      ['tile' 
      [[sim_class tile]
       [attributes [['position_x' [[published true]
				   [subscribed true]
		      		   [slot sim_x]]]
